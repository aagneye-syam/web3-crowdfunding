...
const InstallScanScreen = (props) => {
    ...
    return (_jsxs(Container, { animate: "fadein", expand: true, children: [_jsx(ModalHeader, { title: props.walletName, onBack: props.onBack }), _jsx(Spacer, { y: "xl" }), _jsxs(Container, { flex: "column", expand: true, center: "both", style: {
                    textAlign: "center",
                }, children: [_jsx(QRCode, { qrCodeUri: props.url, QRIcon: _jsx(WalletImage, { id: props.walletId, size: iconSize.xxl, client: client }) }), _jsx(Spacer, { y: "xl" }), _jsx(Text, { multiline: true, center: true, balance: true, children: props.locale.scanToDownload }), _jsx(Spacer, { y: "xs" })] })] }));
};
