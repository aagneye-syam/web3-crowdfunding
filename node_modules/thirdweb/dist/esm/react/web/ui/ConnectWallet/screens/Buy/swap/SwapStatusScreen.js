...
export function SwapStatusScreen(props) {
    ...
    return (_jsx(Container, { animate: "fadein", children: _jsxs(Container, { p: "lg", children: [_jsx(ModalHeader, { title: "Buy", onBack: props.onBack }), _jsx(Spacer, { y: "sm" }), uiStatus === "success" && (_jsxs(_Fragment, { children: [_jsx(Spacer, { y: "md" }), _jsxs(Container, { color: "success", flex: "column", center: "x", children: [_jsx(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }), _jsx(Spacer, { y: "sm" }), _jsx(Text, { color: "primaryText", size: "lg", children: "Buy Success" })] }), _jsx(Spacer, { y: "xl" }), swapDetails, _jsx(Spacer, { y: "sm" }), !props.isEmbed && (_jsx(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.isBuyForTx ? "Continue Transaction" : "Done" }))] })), uiStatus === "partialSuccess" &&
