...
export function FiatFees(props) {
    return (_jsxs(Container, { flex: "column", gap: "xs", children: [_jsxs("div", { style: {
                ...
                }, children: [_jsx(Text, { inline: true, color: "secondaryText", children: "Amount" }), _jsxs(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrency.amount), 4), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
                const feeAmount = formatNumber(Number(fee.amount), 4);
                return (_jsxs("div", { style: {
                    ...
                    display: "flex",
                    justifyContent: "space-between",
                }, children: [_jsx(Text, { inline: true, color: "secondaryText", children: "Total" }), _jsxs(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrencyWithFees.amount), 4), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] }));
}
