...
export function FiatDetailsScreen(props) {
    ...
    if (hasTwoSteps) {
        ...
        return (_jsx(PostOnRampSwapFlow, { client: props.client, status: status, onBack: props.onBack, onViewPendingTx: props.onBack, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: {
