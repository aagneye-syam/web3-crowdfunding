...
export function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return (_jsx(PostOnRampSwap, { buyWithFiatStatus: statusForSwap, client: props.client, onViewPendingTx: props.onViewPendingTx, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed }));
    }
    // show step 1 and step 2 details
    return (_jsx(FiatSteps, { client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
