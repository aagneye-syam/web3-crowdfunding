...
export function BuyTokenInput(props) {
    ...
    return (_jsxs(Container, { children: [_jsx("div", { onClick: (e) => {
                    e.currentTarget.querySelector("input")?.focus();
                        ...
                        flexWrap: "nowrap",
                    }, children: [_jsx(Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", placeholder: "0", type: "text", "data-placeholder": props.value === "", value: props.value || "0", disabled: props.freezeAmount, onClick: (e) => {
