...
const ConnectingScreen = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { animate: "fadein", fullHeight: true, flex: "column", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", style: {
                    paddingBottom: 0,
                }, children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: props.walletName, onBack: props.onBack }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", center: "y", expand: true, px: connectModal.size === "compact" ? "lg" : "xxl", relative: true, style: {
                    paddingTop: 0,
