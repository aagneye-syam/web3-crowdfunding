...
const Img = (props) => {
    ...
    if (propSrc === undefined) {
        return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: { margin: "auto" }, children: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: widthPx, height: heightPx }) }));
    }
    const getSrc = () => {
        try {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            ...
            alignItems: "center",
            justifyItems: "center",
        }, children: [!isLoaded && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: { margin: "auto" }, children: (0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { width: widthPx, height: heightPx }) })), (0, jsx_runtime_1.jsx)("img", { onLoad: () => {
                    setIsLoaded(true);
