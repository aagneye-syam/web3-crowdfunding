...
function BuyTxHistoryButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
            paddingBlock: index_js_1.spacing.sm,
                    ...
                    flex: 1,
                }, children: [(0, jsx_runtime_1.jsx)(TokenIcon_js_1.TokenIcon, { client: props.client, chain: (0, utils_js_1.getCachedChain)(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
