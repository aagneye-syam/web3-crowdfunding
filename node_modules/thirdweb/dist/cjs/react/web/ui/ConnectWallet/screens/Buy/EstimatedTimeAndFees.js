...
exports.EstimatedTimeAndFees = void 0;
...
function EstimatedTimeAndFees(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { bg: "tertiaryBg", flex: "row", borderColor: "borderColor", style: {
            ...
            borderStyle: "solid",
                            ...
                            : "--" }))] }), (0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { variant: "ghost", onClick: props.onViewFees, gap: "xs", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { color: "accentText", flex: "row", center: "both", children: (0, jsx_runtime_1.jsx)(ViewFeeIcon, { size: index_js_1.iconSize.sm }) }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryText", children: "View Fees" })] })] }));
}
