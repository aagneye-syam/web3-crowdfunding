...
export interface IBurnToClaim extends BaseContract {
    ...
    functions: {
        setBurnToClaimInfo(burnToClaimInfo: IBurnToClaim.BurnToClaimInfoStruct, overrides?: Overrides & {
    ...
    callStatic: {
        setBurnToClaimInfo(burnToClaimInfo: IBurnToClaim.BurnToClaimInfoStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=IBurnToClaim.d.ts.map