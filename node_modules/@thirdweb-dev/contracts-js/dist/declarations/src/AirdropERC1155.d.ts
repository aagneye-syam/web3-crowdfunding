...
export interface AirdropERC1155Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "airdropERC1155" | "contractType" | "contractURI" | "contractVersion" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isTrustedForwarder" | "multicall" | "renounceRole" | "revokeRole" | "setContractURI"): FunctionFragment;
...
export interface AirdropERC1155 extends BaseContract {
    ...
    functions: {
        ...
        airdropERC1155(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC1155.AirdropContentStruct[], overrides?: Overrides & {
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        airdropERC1155(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC1155.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
        contractType(overrides?: CallOverrides): Promise<string>;
        contractURI(overrides?: CallOverrides): Promise<string>;
        contractVersion(overrides?: CallOverrides): Promise<number>;
        getRoleAdmin(role: BytesLike, overrides?: CallOverrides): Promise<string>;
