...
export interface AirdropERC20Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "airdropERC20" | "contractType" | "contractURI" | "contractVersion" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isTrustedForwarder" | "multicall" | "renounceRole" | "revokeRole" | "setContractURI"): FunctionFragment;
...
export interface AirdropERC20 extends BaseContract {
    ...
    functions: {
        ...
        airdropERC20(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC20.AirdropContentStruct[], overrides?: PayableOverrides & {
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        airdropERC20(_tokenAddress: string, _tokenOwner: string, _contents: IAirdropERC20.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
        contractType(overrides?: CallOverrides): Promise<string>;
        contractURI(overrides?: CallOverrides): Promise<string>;
        contractVersion(overrides?: CallOverrides): Promise<number>;
        getRoleAdmin(role: BytesLike, overrides?: CallOverrides): Promise<string>;
