...
export declare function zkDeployContractFromUri(publishMetadataUri: string, constructorParamValues: any[], signer: Signer, storage: ThirdwebStorage, chainId: number, options?: DeployOptions, clientId?: string, secretKey?: string): Promise<string>;
