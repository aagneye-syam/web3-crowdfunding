import { d0 as createLruCache, b4 as getSignerAndProvider, aM as resolveAddress, ak as getCompositeABI, bk as AbiSchema, j as getContractTypeForRemoteName, h as PREBUILT_CONTRACTS_MAP } from './index-e58fdf99.browser.esm.js';
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./smart-contract-a2d06cf4.browser.esm.js')]);
...
async function getContract(params) {
  ...
  const [resolvedAddress, {
    ...
    ContractPublisher
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./contract-publisher-97cee6b4.browser.esm.js').then(function (n) { return n.c; })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
  }
