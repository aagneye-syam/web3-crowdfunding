import { d5 as createLruCache, b9 as getSignerAndProvider, aR as resolveAddress, ap as getCompositeABI, bp as AbiSchema, j as getContractTypeForRemoteName, h as PREBUILT_CONTRACTS_MAP } from './index-ab5604e1.esm.js';
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./smart-contract-67378ae1.esm.js')]);
...
async function getContract(params) {
  ...
  const [resolvedAddress, {
    ...
    ContractPublisher
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./contract-publisher-f8c2c9f0.esm.js').then(function (n) { return n.c; })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
  }
